...
```{r, message = FALSE, warning = FALSE}
LRAA_tpm_df <- as.data.frame(sapply(sample_ids, function(sample_id) {
    tx_df <- read_delim(file.path(
        result_dir, glue("../__LRAA/LRAA_{sample_id}_transcript_tpm.tsv")
    ))
    tpm_values <- tx_df$TPM
...
spearman_cor_df <- data.frame(
    ...
    value = c(
        ...
        cor(LRAA_tpm_df$mixA_ont, ref_tx_df$MIX_A, method = "spearman"),
        cor(LRAA_tpm_df$mixB_ont, ref_tx_df$MIX_B, method = "spearman"),
        cor(c(LRAA_tpm_df$mixA_ont, LRAA_tpm_df$mixB_ont),
            c(ref_tx_df$MIX_A, ref_tx_df$MIX_B), method = "spearman")
...
mean_rel_diff_df <- data.frame(
    ...
    value = c(
        ...
        mean_rel_diff(LRAA_tpm_df$mixA_ont, ref_tx_df$MIX_A),
        mean_rel_diff(LRAA_tpm_df$mixB_ont, ref_tx_df$MIX_B),
        mean_rel_diff(c(LRAA_tpm_df$mixA_ont, LRAA_tpm_df$mixB_ont),
                      c(ref_tx_df$MIX_A, ref_tx_df$MIX_B))
