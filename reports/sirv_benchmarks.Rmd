...
LRAA_intron_list <- lapply(sample_ids, function(sample_id) {
    ...
    count_df <- count_df[count_df[, 6, drop = TRUE] > 0,]
...
write.table(LRAA_tx_classes %>% dplyr::select(compatible_tx, tx_class), file="../sirv_analysis/__LRAA/run_insufficient/LRAA.insuff.TP_FP_classes", sep="\t", row.names=F, quote=F)
