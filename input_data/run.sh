...
wget https://zenodo.org/record/10895722/files/COV362_Rep2.fastq.gz
wget https://zenodo.org/record/10895722/files/IGROV-1_Rep2.fastq.gz
wget https://zenodo.org/record/10895722/files/OVKATE_Rep2.fastq.gz
wget https://zenodo.org/record/10895722/files/OVMANA_Rep2.fastq.gz
wget https://zenodo.org/record/10895722/files/OVTOKO_Rep2.fastq.gz
wget https://zenodo.org/record/10895722/files/SK-OV-3_Rep2.fastq.gz
cd ..
...
wget https://zenodo.org/record/10895895/files/OVTOKO_Rep1.bam
samtools index OVTOKO_Rep1.bam
wget https://zenodo.org/record/10895895/files/SK-OV-3_Rep1.bam
